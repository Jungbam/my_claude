import type { Pipeline, AgentCall } from './types'
import { DEPT_MAP } from './parser'
import { formatDuration, sanitizeId } from './utils'
 ...
 */
export function generateFlowchart(pipeline: Pipeline): string {
